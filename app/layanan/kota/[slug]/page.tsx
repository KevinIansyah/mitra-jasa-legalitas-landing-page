...
import { getCities, getServicesByCity } from '@/lib/api/endpoints/service.server';
...
const getCachedCityPayload = cache(async (slug: string) => {
  try {
    return await getServicesByCity(slug, { sort: 'popular' });
  } catch (e: unknown) {
