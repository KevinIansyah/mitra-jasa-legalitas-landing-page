...
import { Calculator, Scale, Copyright, Building, Globe2, Crown, Users, ArrowUpRight } from "lucide-react";
...
const NETWORK_PARTNER: NetworkPartnerCard[] = [
  {
    ...
    description: "Layanan perpajakan dan pembukuan profesional - SPT Tahunan, laporan keuangan, hingga pendampingan pemeriksaan pajak.",
    icon: Calculator,
  ...
  },
  {
    ...
    description: "Pendampingan sengketa bisnis, penyusunan kontrak, dan konsultasi hukum korporat dengan biaya yang transparan.",
    icon: Scale,
  ...
  },
  {
    ...
    description: "Pendaftaran merek, hak cipta, dan paten. Kami pastikan aset intelektual bisnis Anda terlindungi secara hukum.",
    icon: Copyright,
  ...
  },
  {
    ...
    description: "Pengurusan sertifikat HGB, HM, IMB/PBG, serta pengecekan legalitas tanah dan properti sebelum transaksi.",
    icon: Building,
  ...
  },
  {
    ...
    description: "Fasilitasi investasi, business setup untuk startup digital, serta pendampingan regulasi fintech dan e-commerce.",
    icon: Globe2,
  ...
  },
  {
    ...
    description: "Benefit prioritas untuk klien korporat - dedicated konsultan, SLA respon 2 jam, diskon semua layanan, dan akses member.",
    icon: Crown,
  ...
  },
  {
    ...
    description: "Konsultasi ketenagakerjaan, penyusunan PKB & SOP HR, pendampingan BPJS, hingga rekrutmen tenaga profesional.",
    icon: Users,
...
function MitraCard({ partner, cardIndex, wide }: { partner: NetworkPartnerCard; cardIndex: number; wide?: boolean }) {
  ...
  return (
    ...
    >
      <div className="blog-card group flex flex-col h-full gap-5 rounded-2xl border border-gray-200 bg-white p-5">
        <div className="flex items-start justify-between gap-3">
          <div className="w-11 h-11 rounded-xl flex items-center justify-center shrink-0 transition-transform duration-300 group-hover:scale-110" style={{ backgroundColor: partner.bg }}>
          ...
          >
            <ArrowUpRight className="w-3.5 h-3.5" style={{ color: partner.accent }} />
          </div>
        </div>
        ...
        <div className="flex-1 space-y-1.5">
          ...
          <h3 className="text-base font-bold text-gray-900 group-hover:text-brand-blue transition-colors">{partner.name}</h3>
          ...
          <SectionHeading
            ...
            title={
              <>
                ...
                <span style={{ color: "oklch(0.7319 0.1856 52.89)" }}>untuk Setiap Kebutuhan Bisnis</span>
              </>
            }
