...
function buildWhyUsStats(homeStats: HomeStats) {
  return [
    ...
    },
    {
      ...
      suffix: "+",
      value: homeStats.total_documents,
      kind: "count" as const,
    },
    {
      key: "years",
      label: "Pengalaman",
      suffix: " thn",
      value: homeStats.years_experience,
      kind: "count" as const,
    },
    {
      key: "rating",
      ...
      reviews: homeStats.total_reviews,
    },
  ];
}
...
const REASONS = [
  {
    ...
    description: "Selesaikan legalitas dalam 7-14 hari kerja dengan alur yang terstruktur dan tim yang berdedikasi.",
  ...
  },
  {
    ...
    description: "Tidak ada biaya tersembunyi. Semua biaya dikomunikasikan sejak konsultasi awal sebelum Anda memutuskan.",
  ...
  },
  {
    ...
    description: "Didampingi konsultan hukum profesional dengan pengalaman lebih dari 10 tahun di bidang legalitas bisnis.",
  ...
  },
  {
    ...
    description: "Konsultasi awal tanpa biaya untuk memahami kebutuhan legalitas Anda sebelum proses dimulai.",
  ...
  },
  {
    ...
    description: "Jaminan kepuasan penuh dengan revisi gratis hingga dokumen benar-benar sesuai kebutuhan Anda.",
  ...
  },
  {
    ...
    description: "Tim siap mendampingi Anda kapan pun dibutuhkan dengan respons cepat via WhatsApp dan email.",
    color: "oklch(0.5 0.13 270)",
    bg: "oklch(0.5 0.13 270 / 0.1)",
  },
];

const highlights = ["Dokumen 100% sah secara hukum", "Pendampingan end-to-end", "Update status real-time", "Arsip digital seumur hidup"];
    ...
    <section className="py-20 lg:py-28 bg-surface-card overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-4 gap-5 items-stretch">
          ...
          >
            <div className="absolute -top-20 -right-20 w-56 h-56 rounded-full opacity-10 pointer-events-none" style={{ backgroundColor: "white" }} />
            <div className="absolute -bottom-14 -left-14 w-44 h-44 rounded-full opacity-15 pointer-events-none" style={{ backgroundColor: "oklch(0.7319 0.1856 52.89)" }} />
            ...
            <SectionHeading
              ...
              title={
                <>
                  ...
                  <span style={{ color: "oklch(0.7319 0.1856 52.89)" }}>Kami Adalah Mitra Anda.</span>
                </>
              }
              description={<span className="text-white">Kami hadir bukan hanya untuk mengurus dokumen, tapi memastikan bisnis Anda berdiri di fondasi hukum yang kokoh.</span>}
              align="left"
            />
                ...
                <div key={item.key}>
                  {item.kind === "count" ? (
                    <p className="text-3xl font-extrabold text-white leading-none tabular-nums">
                      <CountUp to={item.value} suffix={item.suffix} duration={2} />
                    </p>
                  ) : (
                    <p className="text-3xl font-extrabold text-white leading-none tabular-nums">
            ...
            {REASONS.map((reason, reasonIndex) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{ duration: 0.5, delay: reasonIndex * 0.08, ease: EASE }}
                ...
                >
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 transition-transform group-hover:scale-110" style={{ backgroundColor: reason.bg }}>
                    <Icon className="w-5 h-5" style={{ color: reason.color }} />
                  </div>

                  <div className="space-y-1.5">
                    <h3 className="text-sm font-bold text-gray-900 dark:text-gray-100 group-hover:text-brand-blue transition-colors">{reason.title}</h3>
                    <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">{reason.description}</p>
                  </div>
                </motion.div>
              );
            })}
