  ...
  try {
    ...
    return {
      ...
      openGraph: {
        ...
        ...(og["og:image"] ? { images: [{ url: og["og:image"] as string }] } : {}),
      },
      twitter: {
        ...
        ...(tw["twitter:image"] ? { images: [tw["twitter:image"] as string] } : {}),
      },
    };
  } catch {
    return {
...
export default async function Page() {
  ...
  return (
    <>
      {home.seo.json_ld && <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(home.seo.json_ld) }} />}
