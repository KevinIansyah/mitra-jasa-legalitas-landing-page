...
const PAGE_TITLE = "Syarat dan Ketentuan Layanan";
const PAGE_DESCRIPTION =
  "Syarat dan ketentuan penggunaan layanan konsultasi dan pengurusan legalitas CV. Mitra Jasa Legalitas.";
const PAGE_PATH = "/syarat-ketentuan-layanan";
...
export default async function Page() {
  ...
  return (
    <>
      ...
      <TermsOfServiceContent heroDescription={PAGE_DESCRIPTION} />
    </>
  );
}
