...
export function LupaPasswordForm() {
  ...
  return (
    <div className="w-full max-w-[400px] mx-auto flex flex-col items-stretch">
      ...
      <p className="mt-2 text-center text-sm text-muted-foreground">Masukkan email akun Anda. Kami akan mengirimkan tautan atau kode untuk mengatur ulang password.</p>
