...
export async function postChatbotSession(body: {
...
export async function patchChatbotLead(
  sessionToken: string,
...
export function isChatbotSendOffline(
  data: ChatbotSendResponse,
): data is ChatbotSendOffline {
